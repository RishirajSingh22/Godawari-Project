...
import style from "../CommunityWelfareComponent/Styles/TopImage.module.css"
...
<div className={` ${style.videocontainer}`}>
                ...
                <div className={` ${style.videoContent}`}>
                    <h6 className={style.womenSubHeading}>Transforming Lives With</h6>
                    <h3 className={`mx-auto ${style.womenEmpHeading}`}> Community Welfare</h3>
                </div>
            </div>  )
}
