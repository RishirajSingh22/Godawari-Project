...
import style from "./Styles/womenempowermentbanner.module.css"
        ...
        <>
            <div className={` ${style.videocontainer}`}>
                ...
                <div className={` ${style.videoContent}`} data-aos="fade-left">
                    <h6 className={style.womenSubHeading}>Building a Future of Equality &</h6>
                    <h3 className={`mx-auto ${style.womenEmpHeading}`}>Opportunity for Women</h3>
                </div>
            </div>
        </>
    )
